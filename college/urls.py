...
from college.views.temporary import SEOCollegesView, topCollegesView, tagCollegesView, taglocCollegesView, tagstreamCollegesView
...
urlpatterns = [
    ...
    path('<tag>-colleges/', tagstreamCollegesView.as_view(), name='tagstr-list'),
