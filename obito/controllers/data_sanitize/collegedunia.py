...
def create_datasets(get_offset_url=None,college_id=None, path_to_csv = None):
    ...
    offset_a = soup.find('a', class_="jsx-3870141760 qna-view-all")
    reviews = requests.get(offset_a['href'], headers={'User-Agent':'Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.163 Safari/537.36'}).text
